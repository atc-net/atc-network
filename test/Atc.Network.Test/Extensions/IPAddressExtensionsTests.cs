...
public class IPAddressExtensionsTests
{
    ...
    [InlineData(false, "100.64.0.0")]
    [InlineData(false, "100.127.255.255")]
    [InlineData(false, "172.16.0.0")]
    [InlineData(false, "172.31.255.255")]
    [InlineData(false, "192.0.0.0")]
    [InlineData(false, "192.0.0.255")]
    [InlineData(false, "192.168.0.0")]
    [InlineData(false, "192.168.255.255")]
    [InlineData(false, "198.18.0.0")]
    ...
    [InlineData(true, "100.64.0.0")]
    [InlineData(true, "100.127.255.255")]
    [InlineData(true, "172.16.0.0")]
    [InlineData(true, "172.31.255.255")]
    [InlineData(true, "192.0.0.0")]
    [InlineData(true, "192.0.0.255")]
    [InlineData(true, "192.168.0.0")]
    [InlineData(true, "192.168.255.255")]
    [InlineData(true, "198.18.0.0")]
